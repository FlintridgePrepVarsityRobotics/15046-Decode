...
public class testAuto extends OpMode {
    ...
    private final Pose scorePose = new Pose(38.4, 96.39183673469388, Math.toRadians(128)); // Scoring Pose of our robot. It is facing the goal at a 135 degree angle.
    private final Pose pickup1Pose = new Pose(44.27755102040816, 84.24489795918367, Math.toRadians(180));
