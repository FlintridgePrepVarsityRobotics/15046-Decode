...
@Autonomous(name = "RedFarAuto", group = "fruitauto")
public class RedFarAuto extends OpMode {
    ...
    private final Pose startPose  = new Pose(144-62.72691807542263,  8.801040312093622, Math.toRadians(90));
    private final Pose scorePose  = new Pose(144-58.23276983094928, 18.725617685305593, Math.toRadians(66));
    private final Pose pickup1Pose      = new Pose(144-41.941482444733424, 35.39141742522757, Math.toRadians(0));
    private final Pose pickup1intakePose= new Pose(144-10.040312093628103, 35.39141742522757, Math.toRadians(0));
    private final Pose parkPose      = new Pose(144-35.94950911640954, 8.280504908835908, Math.toRadians(0));

    //    private final Pose pickup2Pose      = new Pose(41.941482444733424, 59.17295188556567, Math.toRadians(180));
    private final Pose pickup2intakePose= new Pose(144-10.040312093628103, 59.17295188556567, Math.toRadians(0));
    private final Pose pickup3Pose = new Pose(144-41.94148244473342, 35.39141742522757, Math.toRadians(0));
    private final Pose pickup3intakePose = new Pose(144-10.04031209362809, 35.39141742522757, Math.toRadians(0));
