...
//    }
    ...
    public void buildPaths() {
        ...
        Corner = follower.pathBuilder()
                .addPath(new BezierCurve(new Pose(54.000, 15.000), new Pose(34.250, 30.000), new Pose(13, 25.000)))
        ...
        CornerIntake = follower.pathBuilder()
                .addPath(new BezierLine(new Pose(13, 25.000), new Pose(12, 8)))
        ...
        Scoring2 = follower.pathBuilder()
                .addPath(new BezierCurve(new Pose(13, 8), new Pose(38.250, 20.000), new Pose(54.000, 15.000)))
