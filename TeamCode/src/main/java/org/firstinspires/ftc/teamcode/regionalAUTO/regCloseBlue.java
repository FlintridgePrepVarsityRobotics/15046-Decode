...
@Autonomous(name = "Regional Close Blue")
...
//    }
    ...
    public void buildPaths() {
        Shooting = follower.pathBuilder().addPath(
                ...
                ).setLinearHeadingInterpolation(Math.toRadians(143.5), Math.toRadians(136))
                .build();
        Spike2Alignment = follower.pathBuilder().addPath(
                ...
                ).setLinearHeadingInterpolation(Math.toRadians(136), Math.toRadians(185))
        ...
        Park = follower.pathBuilder().addPath(
                ...
                ).setLinearHeadingInterpolation(Math.toRadians(138.5), Math.toRadians(114))
                .build();
    }
