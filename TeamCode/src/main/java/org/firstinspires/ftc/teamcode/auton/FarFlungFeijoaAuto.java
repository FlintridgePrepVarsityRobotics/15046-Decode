...
public class FarFlungFeijoaAuto extends OpMode {
    ...
    private final Pose startPose = new Pose(144-56, 8, Math.toRadians(180-90)); // Start Pose of our robot.
    private final Pose scorePose = new Pose(144-72.303, 22.822, Math.toRadians(180-118)); // Scoring Pose of our robot. It is facing the goal at a 135 degree angle.
    private final Pose pickup1Pose = new Pose(144-45.240, 35.950, Math.toRadians(180-180));
    private final Pose pickupintakePose = new Pose(144-18.985, 35.546, Math.toRadians(180-118));
...
//    public static class Paths { //MARK: PedroPathing Visualizer code ----------------------------------------------------------------------------------------------------
//
...
//                    .pathBuilder()
//                    .addPath(
//                            new BezierLine(new Pose(56.000, 8.000), new Pose(72.303, 22.822))
//                    )
...
//                    .pathBuilder()
//                    .addPath(
//                            new BezierLine(new Pose(72.303, 22.822), new Pose(45.240, 35.950))
//                    )
...
//                    .pathBuilder()
//                    .addPath(
//                            new BezierLine(new Pose(45.240, 35.950), new Pose(18.985, 35.546))
//                    )
...
//                    .pathBuilder()
//                    .addPath(
//                            new BezierLine(new Pose(18.985, 35.546), new Pose(72.101, 22.822))
//                    )
        ...
        switch (pathState) {
            ...
            case 3:
                ...
                if (!follower.isBusy()) {
                    ...
                    if (!shooting && shotsFired == 0 && headingError < Math.toRadians(5)) {
                        targetRPM = 3100;  // restore your launch RPM
                        startShooting3();
                    }
