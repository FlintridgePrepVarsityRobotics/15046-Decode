...
@Autonomous(name="Concept: Change PID intake", group = "Concept")
public class PIDtuningINTAKE extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        PIDCoefficients pidOrig = robot.intake.getPIDCoefficients(DcMotor.RunMode.RUN_USING_ENCODER);

        // change coefficients using methods included with DcMotorEx class.
        PIDCoefficients pidNew = new PIDCoefficients(NEW_P, NEW_I, NEW_D);
        robot.intake.setPIDCoefficients(DcMotor.RunMode.RUN_USING_ENCODER, pidNew);

        // re-read coefficients and verify change.
        PIDCoefficients pidModified = robot.intake.getPIDCoefficients(DcMotor.RunMode.RUN_USING_ENCODER);
