...
@Autonomous(name = "FarFlungFigAuto", group = "fruitauto")
public class FarFlungFigAuto extends OpMode {
    ...
    private final Pose scorePose = new Pose(72.303, 22.822, Math.toRadians(118)); // Scoring Pose of our robot. It is facing the goal at a 135 degree angle.
    private final Pose pickup1Pose = new Pose(45.240, 35.950, Math.toRadians(180));
    private final Pose pickupintakePose = new Pose(18.985, 35.546, Math.toRadians(118));
        ...
        switch (pathState) {
            ...
            case 3:
                ...
                if (!follower.isBusy()) {
                    ...
                    if (!shooting && shotsFired == 0 && headingError < Math.toRadians(5)) {
                        targetRPM = 3400;  // restore your launch RPM
                        startShooting3();
                    }
